...
def test_collects_duplicates_from_quests_and_items(tmp_path: Path) -> None:
    ...
    _write_json(
        quests_dir / "astronomy" / "andromeda.json",
        {
            ...
            "description": "Chart the Andromeda nebulae visuals.",
        },
    )
    _write_json(
    ...
    _write_json(
        ...
        [
            ...
            },
            {
                ...
                "name": "Tank 200",
                "image": "/assets/quests/solar.jpg",
                "description": "Reservoir tank with solar heating coil.",
            },
        ],
    )
    ...
    assert "tank-200" in formatted
    assert '"Chart the Andromeda nebulae visuals."' in formatted
    assert '"Reservoir tank with solar heating coil."' in formatted
