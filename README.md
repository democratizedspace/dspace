...
If your platform cannot use prebuilt binaries for `canvas` (a transitive dependency used by
chart-generation tooling), install native build prerequisites first:

- macOS (Homebrew): `brew install pkg-config cairo pango libpng jpeg giflib pixman`
