...
The repository now includes an automated chart visualizing how many quests and lines of dialogue exist in each tree. The image is regenerated by GitHub Actions after pushes.
You can view the latest snapshot [here](./frontend/src/pages/docs/images/quest-tree-stats.png).
