...
const rootDocsFile = path.join(__dirname, '..', 'docs', 'new-quests.md');
...
function generateMarkdown(sections) {
  const lines = [
    ...
    '---',
    '',
    '<!-- Auto-generated by scripts/update-new-quests.js; merge=ours via .gitattributes. -->',
    '<!-- Run `npm run new-quests:update` after merging. -->',
    '',
  ];
...
function main() {
  ...
  fs.writeFileSync(rootDocsFile, content);
}
