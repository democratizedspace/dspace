...
- `astronomy/basic-telescope`
  - [x] Observed issue (addressed): `astronomy/basic-telescope` now uses explicit evidence logging and safety sign-off before completion instead of relying on a single verification hop. (PR #0000)
...
- `astronomy/observe-moon`
  - [x] Observed issue (addressed): `astronomy/observe-moon` now separates session readiness, artifact verification, and recovery handling for degraded observing conditions. (PR #0000)
...
- `astronomy/venus-phases`
  - [x] Observed issue (addressed): `astronomy/venus-phases` now enforces deterministic out-of-range recovery by resetting failed measurements before re-test loops. (PR #0000)
