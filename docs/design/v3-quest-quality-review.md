...
- `aquaria/aquarium-light`
  ...
  - [ ] Insert troubleshooting/recovery handling so failures produce actionable next steps and a verification retry before `finish`.
- `aquaria/balance-ph`
  - [x] Observed issue: `aquaria/balance-ph` centers on a measurement/check action but acceptance thresholds and out-of-range handling are thin. (PR #0000)
...
- `aquaria/breeding`
  - [x] Observed issue: `aquaria/breeding` is lifecycle-oriented but can read as narration unless staged setup and outcome proofs are separated. (PR #0000)
...
- `aquaria/filter-rinse`
  - [x] Observed issue: `aquaria/filter-rinse` describes a cleaning cycle without a measurable before/after success definition. (PR #0000)
