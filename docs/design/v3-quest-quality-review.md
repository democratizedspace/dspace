...
- `aquaria/heater-install`
  ...
  - [x] Add rollback/lockout-avoidance handling with a re-verify checkpoint before retrying the install path. (PR #3620, #3746, #3776)
- `aquaria/log-water-parameters`
  ...
  - [x] Define required log fields/cadence/thresholds and gate completion on the produced log or monitoring snapshot artifact. (PR #3620, #3776)
...
- `aquaria/ph-strip-test`
  ...
  - [x] Add an out-of-range corrective branch with a mandatory re-test loop and explicit pass/fail bounds. (PR #3620, #3776)
