...
- `astronomy/andromeda`
  - [x] Observed issue: `astronomy/andromeda` still trends toward thin-shell progression with limited decision points and weak intermediate proof gates. (PR #0000)
...
- `astronomy/aurora-watch`
  - [x] Observed issue: `astronomy/aurora-watch` is observation-heavy but fallback handling for seeing/weather constraints is typically thin. (PR #0000)
...
- `astronomy/iss-photo`
  - [x] Observed issue: `astronomy/iss-photo` centers on a measurement/check action but acceptance thresholds and out-of-range handling are thin. (PR #0000)
