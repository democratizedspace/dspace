...
- `3dprinting/nozzle-clog`
  - [x] Observed issue: `3dprinting/nozzle-clog` asks for logging/monitoring but pass criteria and anomaly response are not explicit. (#3594)
  - [x] Define required log fields/cadence/thresholds and gate completion on the produced log or monitoring snapshot artifact. (#3594)
  - [x] Add an anomaly classification branch with corrective action and a follow-up verification window before closure. (#3594)
