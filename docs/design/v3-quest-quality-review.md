...
- `geothermal/check-loop-outlet-temp`
  - [x] Observed issue: `geothermal/check-loop-outlet-temp` centers on a measurement/check action but acceptance thresholds and out-of-range handling are thin. (PR #0000)
