...
4. **Fallback option**
   - If a node becomes corrupted or unreachable, replace it through the canonical Sugarkube
     deployment flow in the [DSPACE Sugarkube release runbook](./sugarkube-release.md) and
     the [Sugarkube DSPACE app runbook](https://github.com/futuroptimist/sugarkube/blob/main/docs/apps/dspace.md).
