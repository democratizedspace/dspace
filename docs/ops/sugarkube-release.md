...
The bare `3.1.0` value is the existing Sugarkube compatibility/version promote form once 3.1.0
artifacts are published and approved. The image workflow publishes the version image tag as
`v3.1.0`; branch-SHA tags such as
