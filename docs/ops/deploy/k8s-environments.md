...
[`docs/k3s-sugarkube-staging.md`](../../k3s-sugarkube-staging.md); use the dev/staging/prod runbooks
for end-to-end cluster setup and ingress. This guide stays as the raw `kubectl` / `kustomize`
