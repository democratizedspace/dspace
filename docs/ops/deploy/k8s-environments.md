...
a specific environment without rewriting the base manifests under `infra/k8s/`. These manifests are
intended for the k3s clusters we bring up with sugarkube; pair them with the steps in
[`docs/k3s-sugarkube-dev.md`](../../k3s-sugarkube-dev.md) to match the live Raspberry Pi staging
environment.
