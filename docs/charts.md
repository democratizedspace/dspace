...
from the OCI registry using the latest version (see `charts/dspace/Chart.yaml`,
`docs/apps/dspace.version`, or the registry for available versions). The current published
chart version is `3.0.0`.
