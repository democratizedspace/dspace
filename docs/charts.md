...
directly from the OCI registry using the latest prepared release-candidate version (currently
`3.1.0`; see `docs/apps/dspace.version` or the registry for available versions):
