...
3. **Verify locally (no tunnel by default):**
   ...
   - In another shell, run:
     ...
     - (optional) open http://localhost:3000/ in a browser
...
- Prefer immutable tags (`v3-<shortsha>`) when reproducing a bug, testing rollback behavior, or
  comparing two specific builds.
