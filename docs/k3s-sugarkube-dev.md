...
- The sugarkube helpers read the chart version from `docs/apps/dspace.version` in this repository
  (currently `3.0.0`). Keep that file in sync with `charts/dspace/Chart.yaml` before publishing.
