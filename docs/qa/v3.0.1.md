...
- [x] QA signoff confirms this checklist and executed test scope were derived from the audited commit delta above
  - Evidence: Codex audited
    ...
    for the v3.0.1 candidate and also audited the fixed mainline snapshot
    `3ec45a5517a35c96767f6b946c01104e6ec88f93..5e04b4d5b944922be33ed86144d4181054643015`
    for v3.1 coverage on 2026-05-17. The v3.0.1 checklist scope matches the
    candidate delta, and the April 2026 changelog notes now surface the user-visible changes from
    the audited mainline snapshot without closing staging, production, rollback, or release-closeout
    gates.
