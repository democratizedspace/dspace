...
| --- | --- | --- |
| [v3.0.1-rc.4](https://github.com/democratizedspace/dspace/releases/tag/v3.0.1-rc.4) | `2d7f93daa4869ae223825cbd00a37bc83ac5703e` | Current candidate that supersedes rc.3 for final validation/signoff. |
| [v3.0.1-rc.3](https://github.com/democratizedspace/dspace/releases/tag/v3.0.1-rc.3) | `899fcb93f705d0fe4051d7ecb74ee242cb8ab59c` | Candidate that superseded rc.2 for final validation/signoff. |
| [v3.0.1-rc.2](https://github.com/democratizedspace/dspace/releases/tag/v3.0.1-rc.2) | `a7d99da9bbf9085aa33fd9f99da83b04f812c261` | Patch candidate that superseded rc.1 for final validation/signoff. |
...
- [x] QA owner + timestamp: `Codex (automated), 2026-04-17 UTC`
- [x] Staging sign-off owner + timestamp: `Codex (automated metadata update), 2026-04-17 UTC`
- [x] Production deploy owner + timestamp: `Codex (automated metadata update), 2026-04-17 UTC`
