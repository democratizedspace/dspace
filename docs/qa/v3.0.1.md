...
- [x] QA signoff confirms this checklist and executed test scope were derived from the audited commit delta above
  - Evidence: Codex audited
    ...
    for the v3.0.1 candidate on 2026-05-17. The v3.0.1 checklist scope matches the
    candidate delta, and the April 2026 changelog patch addendum now references the same audited
    rc.4 range without closing staging, production, rollback, or release-closeout gates.
