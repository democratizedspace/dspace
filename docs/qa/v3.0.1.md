...
3. Verify staging health for this candidate: `/config.json`, `/healthz`, `/livez`.
...
- [ ] Comparison includes exactly two immutable candidates: baseline-from-`3ec45a...` and optimized HEAD
