...
- [x] QA signoff confirms this checklist and executed test scope were derived from the audited commit delta above
  - Evidence: Codex audited
    ...
    for the v3.0.1 candidate and also audited
    `3ec45a5517a35c96767f6b946c01104e6ec88f93..main` for mainline v3.1 coverage
    on 2026-05-17. The v3.0.1 checklist scope matches the candidate delta, and
    `frontend/src/pages/docs/md/changelog/20260401.md` now covers the user-visible changes from
    the audited mainline delta without closing staging, production, rollback, or release-closeout
    gates.
