...
- In fresh Codex Cloud/container environments, run `npm run qa:install-browsers` from the repo root
  before any Playwright E2E command (`test:e2e`, grouped E2E, or remote smoke/migration harnesses).
