...
const ciToggle = process.env.CI ? 1 : 0;
const isCI = Boolean(ciToggle);
const workers = process.env.PW_WORKERS ? parseInt(process.env.PW_WORKERS) : isCI ? 2 : undefined;
const EXPECT_TIMEOUT_MS = ciToggle ? 15000 : 7000;
const TEST_TIMEOUT_MS = ciToggle ? 90000 : 30000;
