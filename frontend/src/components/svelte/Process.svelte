<script>
    ...
    const onProcessStart = async () => {
        ...
        const cannotStartMessage = getProcessCannotStartMessage(processId, process);
        if (cannotStartMessage) {
            startFeedbackMessage = cannotStartMessage;
            return;
        }
