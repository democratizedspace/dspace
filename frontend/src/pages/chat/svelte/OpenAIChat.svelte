<script>
    ...
    import { getDocsRagMeta, getDocsRagComparisonStatus } from '../../../utils/docsRag.js';
    ...
    let docsRagStatus = 'App build SHA unavailable; cannot compare.';
    ...
    onMount(async () => {
        ...
        docsRagStatus = getDocsRagComparisonStatus(appGitSha, docsRagGitSha);
    ...
    {#if showDebug}
        <div class="debug-panel" data-testid="chat-debug-panel">
            ...
            <div class="debug-meta-row">
                ...
                <span class="debug-mono">{docsRagStatus}</span>
            </div>
            {#if debugExpanded}
