...
{#if $isMounted}
    <div>
        ...
        <p>
            When you connect your API key, the chat includes a curated knowledge base covering
            quest lore, items, and highlights from your local inventory so NPCs can answer gameplay
            questions right away while staying in character.
        </p>
    </div>
{/if}
