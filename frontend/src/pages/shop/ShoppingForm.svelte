<script>
    ...
    function generateBuyLink() {
        ...
        buyLink.style.cssText =
            'color: white; background-color: green; text-decoration: none; padding: 10px; border-radius: 20px;';
...
<div>
    ...
    <button class="buy" type="button" id="purchase" on:click={generateBuyLink}
        >Generate {shopAction === 'buy' ? 'buy' : 'sell'} link</button
    >
