...
Quest completions in this tree that previously granted `1 x cured compost bucket` now rotate among theme-appropriate rewards: `first aid kit`, `antiseptic wipes`, `sterile gauze pads`.
