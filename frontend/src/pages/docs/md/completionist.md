...
- Reminder QA: `completionist/reminder` now requires the polished trophy state from `completionist/polish` before reminder setup, plus dry-run verification for cadence/link/timezone and a backup-alert recovery loop.
