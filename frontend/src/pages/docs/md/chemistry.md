...
Quest completions in this tree that previously granted `1 x cured compost bucket` now rotate among theme-appropriate rewards: `250 mL glass beaker`, `lab coat`, `pH test strip pack`.
