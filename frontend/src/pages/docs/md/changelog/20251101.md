...
-   `/docs/rockets` now walks through the guided model rocket hop upgrade, from
    printing servo-ready fincans to running a scripted countdown so teams can
    stage a realistic step beyond the parachute baseline.
