...
-   **NEW**: Direct GitHub PR submission workflow for items at [/items/submit](/items/submit) and processes at [/processes/submit](/processes/submit), matching the quest submission experience

Like custom quests, your creations are stored locally by default but can now be submitted to become part of the official game through the same streamlined in-game workflow.
