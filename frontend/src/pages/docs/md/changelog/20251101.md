...
Traefik now terminates HTTPS with cert-manager issued secrets that match each environment's
cloudflared hostname, and the Helm TLS tests keep those overlays from drifting.
