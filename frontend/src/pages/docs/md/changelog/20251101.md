...
-   `/docs/solar` now highlights the shipped wind turbine quest and inventory item,
    replacing the "coming soon" promise about renewable expansion with concrete steps
    for generating dWatt from wind power today.
