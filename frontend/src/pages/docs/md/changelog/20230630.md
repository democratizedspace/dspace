...
<figure>
    <img src="/assets/changelog/20230630/quest.jpg" alt="silhouette of a person standing in front of a cyberpunk city" />
</figure>
...
This update laid the groundwork for the AI companion system that now powers dChat. You can
already ask Sydney, Nova, Hydro, and the rest of the crew open-ended questions through the
[Chat](/chat) console thanks to the GPT-powered upgrade that shipped alongside the v3 launch.
...
Jumping on the AI Chat app trend, I've introduced my own version called dChat. It's a work in progress and may have a few bugs, but I'm continually improving it. dChat now summarizes your quests, achievements, inventory, and processes so answers stay grounded in your current save.

![a screenshot of the dChat, the in-game AI assistant](../../../../../public/assets/changelog/20230630/screenshot_dChat.jpg)

### UI Improvements

We've made several improvements to the user interface to make it more intuitive and responsive. The inventory system has been redesigned for better organization and accessibility.

### New Features

-   Added more detailed progress tracking
-   Improved resource management system
-   Enhanced quest system with better rewards
...
-   If you're a developer hoping to contribute, read the
    ...
    [CONTRIBUTING.md](../../../../../../CONTRIBUTING.md) handbook.
