...
Quest completions in this tree that previously granted `1 x cured compost bucket` now rotate among theme-appropriate rewards: `dWatt`, `portable solar panel`, `Solarpunk Award`.
