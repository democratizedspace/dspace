...
## How you accrue dCarbon

When you generate [dWatt](/docs/dwatt) from an outlet using the smart plug, the game assumes fossil
fuel generation. That means every burst of dWatt also creates dCarbon unless you rely on renewables
like solar panels or wind turbines instead.
