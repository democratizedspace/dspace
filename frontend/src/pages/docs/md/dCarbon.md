...
dCarbon is most commonly generated when minting [dWatt](/docs/dwatt) from an outlet via a smart
plug. Renewable sources like solar and wind can generate dWatt without adding dCarbon.
