...
Quest completions in this tree that previously granted `1 x cured compost bucket` now rotate among theme-appropriate rewards: `hydroponic starter plug`, `hydroponic nutrient concentrate (1 L)`, `Hydro Award`.
