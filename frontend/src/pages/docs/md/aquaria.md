...
Aquaria quests cover the `aquaria` skill tree. This guide documents every quest gate,
...
4. [Test water parameters](/quests/aquaria/water-testing)
5. [Install a sponge filter](/quests/aquaria/sponge-filter)
6. [Log Water Parameters](/quests/aquaria/log-water-parameters)
7. [Check aquarium pH](/quests/aquaria/ph-strip-test)
8. [Install an aquarium light](/quests/aquaria/aquarium-light)
9. [Rinse Sponge Filter](/quests/aquaria/filter-rinse)
10. [Install an aquarium heater](/quests/aquaria/heater-install)
11. [Balance aquarium pH](/quests/aquaria/balance-ph)
12. [Add guppies](/quests/aquaria/guppy)
13. [Add dwarf shrimp](/quests/aquaria/shrimp)
14. [Perform a partial water change](/quests/aquaria/water-change)
15. [Add Floating Plants](/quests/aquaria/floating-plants)
16. [Catch a fish with a net](/quests/aquaria/net-fish)
17. [Top Off Evaporated Water](/quests/aquaria/top-off)
18. [Breed your guppies](/quests/aquaria/breeding)
19. [Set up an aquarium for a goldfish](/quests/aquaria/goldfish)
...
- Grants:
    - Option/step `grantsItems`: None
    - Quest-level `grantsItems`: None
- Rewards: Heated Walstad aquarium (80 L, 26°C) ×1
- Processes used:
...
## 4) Test water parameters (`aquaria/water-testing`)
...
## 5) Install a sponge filter (`aquaria/sponge-filter`)
...
## 6) Log Water Parameters (`aquaria/log-water-parameters`)
...
## 7) Check aquarium pH (`aquaria/ph-strip-test`)
...
## 8) Install an aquarium light (`aquaria/aquarium-light`)
...
## 9) Rinse Sponge Filter (`aquaria/filter-rinse`)
...
## 10) Install an aquarium heater (`aquaria/heater-install`)
...
## 11) Balance aquarium pH (`aquaria/balance-ph`)
...
- Grants:
    - Option/step `grantsItems`: None
    - Quest-level `grantsItems`: None
- Rewards: Heated Walstad aquarium with guppies (80 L, 26°C) ×1
- Processes used:
    - [`heat-walstad`](/processes/heat-walstad)
        - Requires: none
        - Consumes: Walstad aquarium with thermometer (80 L) ×1, aquarium heater (150 W) ×1
...
## 14) Perform a partial water change (`aquaria/water-change`)
...
## 15) Add Floating Plants (`aquaria/floating-plants`)
...
## 16) Catch a fish with a net (`aquaria/net-fish`)
...
- Rewards: cured compost bucket ×1
- Processes used:
    - `catch-fish` → `/processes/catch-fish` (canonical data not found)
    - `return-fish` → `/processes/return-fish` (canonical data not found)

## 17) Top Off Evaporated Water (`aquaria/top-off`)
...
## 18) Breed your guppies (`aquaria/breeding`)
...
## 19) Set up an aquarium for a goldfish (`aquaria/goldfish`)
...
- Cross-quest dependencies:
    - `aquaria/walstad` unlocks after: welcome/howtodoquests
    - `aquaria/thermometer` unlocks after: aquaria/walstad
    - `aquaria/position-tank` unlocks after: aquaria/walstad, aquaria/thermometer
    - `aquaria/water-testing` unlocks after: aquaria/thermometer
    - `aquaria/sponge-filter` unlocks after: aquaria/position-tank
    - `aquaria/log-water-parameters` unlocks after: aquaria/water-testing
    - `aquaria/ph-strip-test` unlocks after: aquaria/water-testing
    - `aquaria/aquarium-light` unlocks after: aquaria/sponge-filter
    - `aquaria/filter-rinse` unlocks after: aquaria/sponge-filter
    - `aquaria/heater-install` unlocks after: aquaria/sponge-filter, aquaria/thermometer, aquaria/walstad
    - `aquaria/balance-ph` unlocks after: aquaria/ph-strip-test
    - `aquaria/guppy` unlocks after: aquaria/water-testing, aquaria/heater-install
    - `aquaria/shrimp` unlocks after: aquaria/ph-strip-test, aquaria/heater-install, aquaria/log-water-parameters
    - `aquaria/water-change` unlocks after: aquaria/guppy
    - `aquaria/floating-plants` unlocks after: aquaria/shrimp
    - `aquaria/net-fish` unlocks after: aquaria/water-change
    - `aquaria/top-off` unlocks after: aquaria/water-change
    - `aquaria/breeding` unlocks after: aquaria/guppy, aquaria/floating-plants
    - `aquaria/goldfish` unlocks after: welcome/howtodoquests, aquaria/breeding
...
- Known pitfalls / shared-process notes:
    - Process `bucket-water-dechlorinated` is reused in 3 quests (aquaria/filter-rinse, aquaria/floating-plants, aquaria/top-off)
    - Process `condition-bucket-water` is reused in 3 quests (aquaria/sponge-filter, aquaria/walstad, aquaria/water-change)
    - Process `heat-walstad` is reused in 3 quests (aquaria/guppy, aquaria/heater-install, aquaria/position-tank)
    - Process `log-walstad-temperature` is reused in 2 quests (aquaria/heater-install, aquaria/thermometer)
    - Process `partial-water-change` is reused in 2 quests (aquaria/water-change, aquaria/water-testing)
    - Process `restart-sponge-filter` is reused in 2 quests (aquaria/filter-rinse, aquaria/sponge-filter)
    - Process `rinse-aquarium-filter` is reused in 2 quests (aquaria/filter-rinse, aquaria/sponge-filter)
