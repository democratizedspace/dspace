...
Quest completions in this tree that previously granted `1 x cured compost bucket` now rotate among theme-appropriate rewards: `live temperature JSON endpoint`, `temperature log CSV`, `shell transcript`.
