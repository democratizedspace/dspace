...
- Official content currently includes **248 quests across 19 quest trees** (repo snapshot validated on March 20, 2026).
...
- token.place integration exists behind flags but remains disabled for v3 launch sign-off.
- v3 launch support remains OpenAI-only; token.place activation is deferred to v3.1 follow-up work.
- Current status and rollout notes are tracked at [/docs/token-place](/docs/token-place).
