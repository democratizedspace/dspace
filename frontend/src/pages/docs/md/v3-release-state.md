...
- Official content currently includes **248 quests across 19 quest trees** (v3 branch snapshot as
  of March 19, 2026).
...
- token.place remains intentionally disabled for v3 launch and deferred to v3.1.
