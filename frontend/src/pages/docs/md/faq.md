...
sales-tax rate of dCarbon ÷ 1000 percent (for example, 500 dCarbon = 0.5% tax), capped at 90%.
That means renewable energy like [solar power](/docs/solar) or wind turbines is the best
long-term strategy. See [Electricity](/docs/electricity) for the full rules.
