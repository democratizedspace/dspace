...
Quest completions in this tree that previously granted `1 x cured compost bucket` now rotate among theme-appropriate rewards: `rocket igniter`, `guided flight stack`, `Rocketeer Award`.
