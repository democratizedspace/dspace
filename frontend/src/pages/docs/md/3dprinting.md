...
3D Printing quests cover the `3dprinting` skill tree. This guide documents every quest gate,
...
6. [Print a Cable Clip](/quests/3dprinting/cable-clip)
7. [Fix a Clogged Nozzle](/quests/3dprinting/nozzle-clog)
8. [Print a Phone Stand](/quests/3dprinting/phone-stand)
9. [3D Print 25 Benchies](/quests/3dprinting/benchy_25)
10. [Tighten the X-axis Belt](/quests/3dprinting/x-belt-tension)
11. [Clear a Clogged Nozzle](/quests/3dprinting/nozzle-cleaning)
12. [Print a Spool Holder](/quests/3dprinting/spool-holder)
13. [3D Print 100 Benchies](/quests/3dprinting/benchy_100)
14. [Witness a Blob of Death](/quests/3dprinting/blob-of-death)
15. [Tune Retraction Settings](/quests/3dprinting/retraction-test)
16. [Print a Temperature Tower](/quests/3dprinting/temperature-tower)
...
- Rewards: dUSD ×100, Benchy Award ×1
- Processes used:
...
- Grants:
    - Option/step `grantsItems`: None
    - Quest-level `grantsItems`: None
- Rewards: green PLA filament ×1000
- Processes used:
    - None

## 6) Print a Cable Clip (`3dprinting/cable-clip`)
...
## 7) Fix a Clogged Nozzle (`3dprinting/nozzle-clog`)
...
## 8) Print a Phone Stand (`3dprinting/phone-stand`)
...
## 9) 3D Print 25 Benchies (`3dprinting/benchy_25`)
...
- Grants:
    - Option/step `grantsItems`: None
    - Quest-level `grantsItems`: None
- Rewards: green PLA filament ×10000
- Processes used:
    - None

## 10) Tighten the X-axis Belt (`3dprinting/x-belt-tension`)
...
## 11) Clear a Clogged Nozzle (`3dprinting/nozzle-cleaning`)
...
## 12) Print a Spool Holder (`3dprinting/spool-holder`)
...
## 13) 3D Print 100 Benchies (`3dprinting/benchy_100`)
...
- Grants:
    - Option/step `grantsItems`: None
    - Quest-level `grantsItems`: None
- Rewards: green PLA filament ×100000
- Processes used:
    - None

## 14) Witness a Blob of Death (`3dprinting/blob-of-death`)
...
## 15) Tune Retraction Settings (`3dprinting/retraction-test`)
...
## 16) Print a Temperature Tower (`3dprinting/temperature-tower`)
...
- Cross-quest dependencies:
    - `3dprinter/start` unlocks after: welcome/howtodoquests
    - `3dprinting/bed-leveling` unlocks after: 3dprinter/start
    - `3dprinting/calibration-cube` unlocks after: 3dprinting/bed-leveling
    - `3dprinting/filament-change` unlocks after: 3dprinting/calibration-cube
    - `3dprinting/benchy_10` unlocks after: 3dprinting/filament-change
    - `3dprinting/cable-clip` unlocks after: 3dprinting/filament-change
    - `3dprinting/nozzle-clog` unlocks after: 3dprinting/filament-change
    - `3dprinting/phone-stand` unlocks after: 3dprinting/filament-change
    - `3dprinting/benchy_25` unlocks after: 3dprinting/benchy_10
    - `3dprinting/x-belt-tension` unlocks after: 3dprinting/cable-clip
    - `3dprinting/nozzle-cleaning` unlocks after: 3dprinting/nozzle-clog
    - `3dprinting/spool-holder` unlocks after: 3dprinting/phone-stand
    - `3dprinting/benchy_100` unlocks after: 3dprinting/benchy_25
    - `3dprinting/blob-of-death` unlocks after: 3dprinting/nozzle-cleaning
    - `3dprinting/retraction-test` unlocks after: 3dprinting/spool-holder
    - `3dprinting/temperature-tower` unlocks after: 3dprinting/retraction-test
...
- Known pitfalls / shared-process notes:
    - Process `3dprint-nozzle-clog` is reused in 2 quests (3dprinting/nozzle-cleaning, 3dprinting/nozzle-clog)
    - Process `level-3d-printer-bed` is reused in 4 quests (3dprinting/bed-leveling, 3dprinting/cable-clip, 3dprinting/phone-stand, 3dprinting/spool-holder)
    - Process `repair-clogged-nozzle` is reused in 2 quests (3dprinting/nozzle-cleaning, 3dprinting/nozzle-clog)
    - Process `swap-white-pla-filament` is reused in 3 quests (3dprinting/cable-clip, 3dprinting/phone-stand, 3dprinting/spool-holder)
    - Process `tighten-x-belt` is reused in 2 quests (3dprinting/spool-holder, 3dprinting/x-belt-tension)
