...
If IndexedDB is unavailable (for example in Safari private mode), the game falls back to
`localStorage` and displays a warning. Progress will still save, but space is limited and
