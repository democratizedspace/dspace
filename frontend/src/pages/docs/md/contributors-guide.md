...
changes to DSPACE. Pair it with the [Developer Guide](https://github.com/democratizedspace/dspace/blob/v3/DEVELOPER_GUIDE.md)
and the [`CONTRIBUTING.md`](https://github.com/democratizedspace/dspace/blob/v3/CONTRIBUTING.md)
...
- Enable the [recommended VS Code extensions](https://github.com/democratizedspace/dspace/blob/v3/.vscode/extensions.json)
...
Refer to the [Testing Guide](https://github.com/democratizedspace/dspace/blob/v3/TESTING.md) for component,
integration, and
