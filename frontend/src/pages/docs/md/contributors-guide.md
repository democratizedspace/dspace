...
[Developer Guide](https://github.com/democratizedspace/dspace/tree/v3/DEVELOPER_GUIDE.md)
and the
[`CONTRIBUTING.md`](https://github.com/democratizedspace/dspace/tree/v3/CONTRIBUTING.md)
...
- Enable the
  [recommended VS Code extensions](https://github.com/democratizedspace/dspace/tree/v3/.vscode/extensions.json)
...
Refer to the
[Testing Guide](https://github.com/democratizedspace/dspace/tree/v3/TESTING.md) for
