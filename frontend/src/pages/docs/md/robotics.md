...
Quest completions in this tree that previously granted `1 x cured compost bucket` now rotate among theme-appropriate rewards: `3D Printed Phone Stand`, `ultrasonic distance sensor`, `Motor Award`.
