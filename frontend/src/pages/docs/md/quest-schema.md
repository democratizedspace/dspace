...
Every quest JSON file must conform to the [quest schema](https://github.com/democratizedspace/dspace/blob/main/frontend/src/pages/quests/jsonSchemas/quest.json) to be
