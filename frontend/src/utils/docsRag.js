...
export const getDocsRagMismatchWarning = (appGitSha, docsGitSha) => {
    const comparison = getDocsRagComparisonMessage(appGitSha, docsGitSha);
    return comparison === 'Docs RAG is stale vs app build.' ? comparison : null;
};
