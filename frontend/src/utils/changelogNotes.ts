...
const notesBySlug: Record<string, ChangelogNote[]> = {
    '20221019': [
        {
            message:
                'Process reservations evolved significantly after this build. For the v3 behavior and related fixes, take a look at the February 1, 2026 release notes.',
    ...
    '20221210': [
        {
            message:
                'The energy and offset systems described below evolved over time. For the up-to-date renewable workflow, review the February 1, 2026 release notes.',
            href: '/docs/changelog/20260201',
            linkLabel: 'February 1, 2026 changelog',
        },
        {
    ...
    '20230101': [
        {
            message:
                'Need the modern process reservation rules? They are documented alongside the v3 architecture refresh in the February 1, 2026 release notes.',
            href: '/docs/changelog/20260201',
            linkLabel: 'February 1, 2026 changelog',
        },
    ],
    '20230630': [
        ...
        {
            message:
                'Inventory filters, the contributor tooling roadmap, and the dChat knowledge base all matured in the February 1, 2026 release. Read the v3 changelog for the latest details.',
            href: '/docs/changelog/20260201',
            linkLabel: 'February 1, 2026 changelog',
        },
        {
    ...
    '20230915': [
        {
            message:
                'Cloud Sync and cross-device backups arrived in the February 1, 2026 release. Check that changelog for setup instructions.',
            href: '/docs/changelog/20260201',
            linkLabel: 'February 1, 2026 changelog',
        },
    ],
