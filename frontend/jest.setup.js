    ...
    const element = {
        ...
        querySelector: function(selector) {
            ...
            if (selector.startsWith('.')) {
                ...
                const matchingChild = this.children.find(child => 
                    child.classList && child.classList.contains && child.classList.contains(className)
                );
          ...
          child.classList && child.classList.contains && child.classList.contains(className)
                ...
                // Tag selector
                const matchingChild = this.children.find(child => child.tagName === selector.toUpperCase());
                return matchingChild || null;
            }
        },
