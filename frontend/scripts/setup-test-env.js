...
const placeholderFiles = [
  ...
  path.join(rootDir, 'test-videos', '.playwright-artifacts-0', 'traces', 'placeholder-recording1.network'),
  path.join(rootDir, 'test-videos', '.playwright-artifacts-0', 'traces', 'placeholder-recording1.trace')
];
