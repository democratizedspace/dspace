...
const TEST_GROUPS = [
    ...
    },
    {
        ...
        files: [
            ...
            'manage-processes.spec.ts',
            'manage-quests.spec.ts',
            'manage-quests-search.spec.ts',
            'legacy-import.spec.ts',
    ...
    },
    {
        name: 'Process Tests',
        files: [
            'process-creation.spec.ts',
            'process-custom-item-selector.spec.ts',
    ...
    },
    {
        ...
        files: [
            ...
            'quests-performance-harness.spec.ts',
        ],
