...
try {
    ...
    if (-not $env:SKIP_LINT) {
        ...
        Write-Host "Step 1/3: SKIP_LINT is set, skipping linting and formatting checks..."
    }
    ...
    # Step 3: Run grouped E2E tests unless skipped
    if (-not $env:SKIP_E2E) {
        ...
        Write-Warning "Remember to run them locally before submitting your PR."
    }
